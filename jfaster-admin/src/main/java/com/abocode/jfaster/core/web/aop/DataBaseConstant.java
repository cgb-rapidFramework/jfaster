...
public interface DataBaseConstant {
     ...
     * 数据-所属公司编码
     */
    String SYS_COMPANY_CODE = "sysCompanyCode";
    /**
     * 数据-所属公司编码
     */
    String SYS_COMPANY_CODE_TABLE = "sys_company_code";
    /**
     * 数据-所属机构编码
     */
     ...
     * 创建用户真是名称
     */
    String CREATE_NAME_TABLE = "create_name";
    /**
     * 创建用户真是名称
     */
     ...
     * 更新用户真是名称
     */
    String UPDATE_NAME_TABLE = "update_name";
    /**
     * 更新用户真是名称
     */
