...
public class InitListener  implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		SystemRepository systemService = (SystemRepository) webApplicationContext.getBean("systemService");
		MenuInitRepository menuInitService = (MenuInitRepository) webApplicationContext.getBean("menuInitService");
		MutiLangRepository mutiLangService = (MutiLangRepository) webApplicationContext.getBean("mutiLangService");
		/**
		 * 第一部分：对数据字典进行缓存
		 */
