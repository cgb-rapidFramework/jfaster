...
public interface IGenericBaseCommonDao {
	 ...
	 * @return
	 */
	 <T> T find(Class<T> entityName, Serializable id);
	 ...
	 * @return
	 */
	 <T> List<T> findAll(final Class<T> entityClass);
	 ...
	 * @return
	 */
	 PageList findPageListByCq(final CriteriaQuery cq, final boolean isOffset);
	 ...
	 * @return
	 */
	 <T> List<T> findListByCq(final CriteriaQuery cq,
			Boolean ispage);
	 ...
	 * @return
	 */
	 Map<Object, Object> findHashMapbyHql(String query);
