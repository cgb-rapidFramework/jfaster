            ...
            <tr style="height: 25px;" align="right">
                <td style="" colspan="2">
                    ...
                    <div style="float: left; line-height: 25px; margin-left: 70px;">
                        <span style="color: #386780"><t:language langKey="common.user"/>:</span>
                        <span style="color: #FFFFFF">${username }</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        <span style="color: #386780"><t:language langKey="current.org"/>:</span>
                        <span style="color: #FFFFFF">${currentOrgName }</span>&nbsp;&nbsp;&nbsp;&nbsp;
                        <span style="color: #386780"><t:language langKey="common.role"/>:</span>
                    ...
                    <div style="float: left; margin-left: 18px;">
                        ...
                        <div id="layout_north_zxMenu" style="width: 100px; display: none;">
                            <div onclick="exit('loginController.do?logout','<t:language langKey="common.exit.confirm"/>',1);">
                                <t:language langKey="common.exit"/>
                            </div>
                        </div>
                    </div>
...
<!-- 左侧-->
<div region="west" split="true" href="loginController.do?shortcut_top" title="<t:language langKey="common.navegation"/>" style="width: 200px; padding: 1px;"></div>
<!-- 中间-->
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="http://www.hulasou.org" target="_blank" title="<t:language langKey="system.name" />"><t:language langKey="system.name" /></a>
        </span>
    </div>
</div>
