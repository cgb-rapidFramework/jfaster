...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:1px;">
       <t:datagrid name="jobList" title="定时任务" actionUrl="jobController.do?findDataGridData" idField="id" fit="true" queryMode="group">
       ...
       <t:dgToolBar title="录入" icon="icon-add" url="jobController.do?detail" function="add"></t:dgToolBar>
       <t:dgToolBar title="编辑" icon="icon-edit" url="jobController.do?detail" function="update"></t:dgToolBar>
       <t:dgToolBar title="查看" icon="icon-search" url="jobController.do?detail" function="detail"></t:dgToolBar>
      </t:datagrid>
  </div>
 </div>