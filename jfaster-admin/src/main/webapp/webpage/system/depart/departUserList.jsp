...
<t:datagrid name="departUserList" title="common.operation"
	...
	<t:dgToolBar title="common.add.param" langArg="common.user" icon="icon-add" url="userController.do?detail&departid=${departid}" function="add"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.user" icon="icon-edit" url="userController.do?detail&departid=${departid}" function="update"></t:dgToolBar>
	<t:dgToolBar title="common.add.exist.user" icon="icon-add" url="departController.do?goAddUserToOrg&orgId=${departid}" function="add" width="500"></t:dgToolBar>
</t:datagrid>
