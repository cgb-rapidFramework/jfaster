...
<div region="center" style="padding: 1px;"><t:datagrid name="userList2" title="用户管理" actionUrl="userController.do?findDataGridData" idField="id" fit="true">
	<t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
	<t:dgCol title="用户名" sortable="false" field="username" width="20"></t:dgCol>
	<t:dgCol title="部门" field="Depart_departname"></t:dgCol>
	...
	<t:dgFunOpt function="szqm(id)" title="设置签名" />
	<t:dgDelOpt title="删除" url="userController.do?del&id={id}&username={username}" />
</t:datagrid>
<div id="userListtb" style="padding: 3px; height: 25px">
<div style="float: left;"><a href="#" id="add" class="easyui-linkbutton" plain="true" icon="icon-add" onclick="add('用户录入','userController.do?detail','userList2')">用户录入</a> <a href="#"
	class="update" plain="true" icon="icon-edit" onclick="update('用户编辑','userController.do?detail','userList2')">用户编辑</a></div>
