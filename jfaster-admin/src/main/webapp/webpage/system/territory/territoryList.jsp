...
<div region="center" style="padding: 1px;"><t:datagrid name="territoryList" title="area.manage" actionUrl="territoryController.do?territoryGrid" idField="id" treeGrid="true" pagination="false">
	...
	<t:dgToolBar title="common.add.param" langArg="common.area" icon="icon-add" url="territoryController.do?detail" function="addFun"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.area" icon="icon-edit" url="territoryController.do?detail" function="update"></t:dgToolBar>
</t:datagrid></div>
</div>
