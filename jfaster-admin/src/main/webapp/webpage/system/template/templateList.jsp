...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="templateList" title="模版管理" actionUrl="templateController.do?findDataGridData" idField="id" fit="true">
  ...
  <t:dgCol title="登录页" field="pageLogin" width="20"></t:dgCol>
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="templateController.do?detail" function="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="templateController.do?detail" function="update"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="templateController.do?detail" function="detail"></t:dgToolBar>
  </t:datagrid>
  </div>
 </div>