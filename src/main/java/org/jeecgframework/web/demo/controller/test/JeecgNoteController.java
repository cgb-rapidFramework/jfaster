...
public class JeecgNoteController extends BaseController {
	...
	private static final Logger logger = Logger
			.getLogger(JeecgNoteController.class);
	...
	public void datagrid(JeecgNoteEntity jeecgNote, HttpServletRequest request,
		...
		org.jeecgframework.web.command.util.hqlsearch.HqlGenerateUtil
				.installHql(cq, jeecgNote);
		this.jeecgNoteService.findDataGridReturn(cq, true);
	...
	public AjaxJson del(JeecgNoteEntity jeecgNote, HttpServletRequest request) {
		...
		jeecgNote = systemService.findEntity(JeecgNoteEntity.class,
				jeecgNote.getId());
		message = "删除成功";
	...
	public ModelAndView addorupdate(JeecgNoteEntity jeecgNote,
			HttpServletRequest req) {
		if (StringUtil.isNotEmpty(jeecgNote.getId())) {
			jeecgNote = jeecgNoteService.findEntity(JeecgNoteEntity.class,
					jeecgNote.getId());
	...
	public ModelAndView addorupdateNoBtn(JeecgNoteEntity jeecgNote,
			HttpServletRequest req) {
		if (StringUtil.isNotEmpty(jeecgNote.getId())) {
			jeecgNote = jeecgNoteService.findEntity(JeecgNoteEntity.class,
					jeecgNote.getId());
