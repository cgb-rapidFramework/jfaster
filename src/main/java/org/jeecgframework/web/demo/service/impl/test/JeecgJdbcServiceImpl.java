...
import org.jeecgframework.web.utils.JeecgSqlUtil;
...
public class JeecgJdbcServiceImpl extends CommonServiceImpl implements JeecgJdbcServiceI {
	...
	public void getDatagrid1(JeecgJdbcEntity pageObj, DataGrid dataGrid) {
		...
		Long iCount = queryCountByParam(sqlCnt, null);
		...
		List list = queryForListObject("mysql",sql, dataGrid.getPage(), dataGrid.getRows(), JeecgJdbcEntity.class);
	...
	public void getDatagrid2(JeecgJdbcEntity pageObj, DataGrid dataGrid) {
		...
		List<Map<String, Object>> mapList = queryForListMap(sql, dataGrid.getPage(), dataGrid.getRows());
	...
	public void listAllByJdbc(DataGrid dataGrid) {
		...
		List<Map<String, Object>> maplist =jdbcDao.findForJdbcParam(SystemConfigUtil.getJdbcUrl(),sql, dataGrid.getPage(), dataGrid.getRows());
