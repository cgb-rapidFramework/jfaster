...
public class OptimisticLockingServiceImpl extends CommonServiceImpl implements OptimisticLockingServiceI {
	public void  dd (){
        ...
        OptimisticLockingEntity stu1=this.find(OptimisticLockingEntity.class, "2c91992b3f74fd05013f74fda0260001");
        OptimisticLockingEntity stu2=this.find(OptimisticLockingEntity.class, "2c91992b3f74fd05013f74fda0260001");
