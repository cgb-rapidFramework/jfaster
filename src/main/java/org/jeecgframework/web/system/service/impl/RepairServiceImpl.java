...
//		commonDao.saveOrUpdate(cgreport_item);
	...
	private void repairCgFormField() {
		// 表单[订单主信息] - 字段清单
		CgFormHeadEntity jform_order_main = commonDao.findAllByProperty(
		...
		// 表单[请假单] - 字段清单
		CgFormHeadEntity jform_leave = commonDao.findAllByProperty(
...
//		commonDao.saveOrUpdate(jform_cgreport_item_field_type);
		...
		// 表单[订单客户信息] - 字段清单
		CgFormHeadEntity jform_order_customer = commonDao.findAllByProperty(
		...
		// 表单[订单机票信息] - 字段清单
		CgFormHeadEntity jform_order_ticket = commonDao.findAllByProperty(
		...
		// 表单[价格认证机构统计表] - 字段清单
		CgFormHeadEntity jform_price1 = commonDao.findAllByProperty(
	...
	*/}
	...
	private void repairUser() {
		TSDepart eiu = commonDao.findAllByProperty(TSDepart.class, "departname",
				"信息部").get(0);
		TSDepart RAndD = commonDao.findAllByProperty(TSDepart.class, "departname",
				"研发室").get(0);
