...
import com.abocode.jfaster.platform.poi.excel.entity.ExcelCollectionParams;
import com.abocode.jfaster.platform.poi.excel.entity.ExcelImportEntity;
import com.abocode.jfaster.platform.poi.excel.entity.ImportParams;
...
public final class ExcelImportUtil {
	...
	private static Date getDateData(ExcelImportEntity entity, String value) {
		if(!StringUtils.isEmpty(entity.getImportFormat())&&
