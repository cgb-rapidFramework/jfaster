...
public class DepartBean extends IdEntity implements java.io.Serializable {
	private DepartBean TSPDepart;//上级部门
	private String departname;//部门名称
	private String description;//部门描述
    private String orgCode;//机构编码
    private String orgType;//机构编码
	private List<DepartBean> TSDeparts = new ArrayList<DepartBean>();//下属部门

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "parentdepartid")
	public DepartBean getTSPDepart() {
		return this.TSPDepart;
	}

	public void setTSPDepart(DepartBean TSPDepart) {
	...
	public List<DepartBean> getTSDeparts() {
		return TSDeparts;
	}

	public void setTSDeparts(List<DepartBean> tSDeparts) {
		TSDeparts = tSDeparts;
	}
