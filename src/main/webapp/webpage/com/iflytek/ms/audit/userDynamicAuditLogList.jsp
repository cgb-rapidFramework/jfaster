...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="auditLogList" title="用户动态审核日志" actionUrl="auditLogController.do?datagrid&auditType=userDynamicInfo" idField="id" fit="true" queryMode="group">
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="手机号码" field="msisdn"  width="15"></t:dgCol>
    <t:dgCol title="图片数量" field="IMAGENUM" width="12"></t:dgCol>
   <t:dgCol title="内容" field="signature" width="30"></t:dgCol>
   <t:dgCol title="录音时长(秒)" field="voicetime" width="12"></t:dgCol>
