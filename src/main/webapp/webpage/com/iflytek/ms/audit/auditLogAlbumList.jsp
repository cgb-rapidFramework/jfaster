...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="auditLogList" title="相册审核日志" actionUrl="auditLogController.do?datagrid&auditType=Album" idField="id"  queryMode="group" >
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="图片" field="photo"  width="10"  image="true" funname="viewImage" imageSize="80,80"></t:dgCol>
   <t:dgCol title="手机号码" field="msisdn" width="20" query="true"></t:dgCol>
   ...
   <t:dgCol title="审核状态" field="auditstatus" width="15" replace="审核不通过_2,审核通过_1" query="true"></t:dgCol>
   <t:dgCol title="审核人" field="auditorName"  width="15" query="true"></t:dgCol>
   <t:dgCol title="原因说明" field="mark" width="30"></t:dgCol>
  </t:datagrid>
  </div>
 </div>
