...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="auditLogList" title="用户信息审核日志" actionUrl="auditLogController.do?datagrid&auditType=UserInfo" idField="id" fit="true" queryMode="group">
  ...
  <t:dgCol title="用户昵称" field="nickName" ></t:dgCol>
   <t:dgCol title="求聊宣言" field="signature" ></t:dgCol>
