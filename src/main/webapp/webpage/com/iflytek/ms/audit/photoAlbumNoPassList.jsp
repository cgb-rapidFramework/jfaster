...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="photoAlbumList" title="有聊用户相册" actionUrl="photoAlbumController.do?auditedDatagrid&auditstatus=2" idField="id" fit="true" checkbox="true" queryMode="group"> 
   <t:dgCol title="编号" field="id" hidden="true"></t:dgCol>
   <t:dgCol title="照片标识" field="identifiers"  hidden="true"></t:dgCol>
   <t:dgCol title="照片" field="sourceurl"  width="10" funname="viewImage" image="true" imageSize="80,80"></t:dgCol>
   <t:dgCol title="手机号码" field="msisdn" width="15" sortable="false" query="true"></t:dgCol>
   ...
   <t:dgCol title="审核时间" field="lastAuditTime" width="16"  formatter="yyyy-MM-dd hh:mm:ss"></t:dgCol>
    <t:dgCol title="审核人" field="lastAuditorName" width="15" sortable="false"></t:dgCol> 
   <t:dgCol title="审核状态" field="auditstatus" width="10" replace="待审核_0,审核通过_1,审核不通过_2"></t:dgCol>
   <t:dgCol title="不通过次数" field="noPassNum" width="10" sortable="false" funname="veiwNum" url="auditLogController.do?auditLog&msisdn={msisdn}"></t:dgCol>
   ...
   <t:dgCol title="操作" field="opt" width="20" ></t:dgCol>
    <%--  <t:dgConfOpt title="删除图片" url="photoAlbumController.do?deletePhotoAlbum&msisdns={msisdn}&identifiers={identifiers}&type=1" message="确认删除图片？"/> --%>
    ...
    <%-- <t:dgToolBar title="批量删除图片" icon="icon-search" url="photoAlbumController.do?deletePhotoAlbum&type=1" funname="deletePhotoAlbum" ></t:dgToolBar> --%>
