...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="userHeadPhotoInfoList" title="有聊待审核用户信息" actionUrl="userInfoController.do?userHeadPhotoDatagrid&auditstatus=2" idField="id"  checkbox="true" fit="true" queryMode="group">
