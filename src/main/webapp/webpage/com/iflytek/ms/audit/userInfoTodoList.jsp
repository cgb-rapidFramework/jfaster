...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="userInfoList" title="有聊待审核用户信息" actionUrl="userInfoController.do?datagrid&auditstatus=0" idField="id"  checkbox="true" fit="true" queryMode="group">
   ...
   <t:dgConfOpt title="审核通过" url="userInfoController.do?saveAudit&ids={id}&auditstatus=1&auditType=userTextInfo" message="确认通过？"/>
   <t:dgFunOpt title="审批不通过" funname="audit(id)" />
   
   <t:dgToolBar title="批量通过" icon="icon-search" url="userInfoController.do?saveAudit&auditstatus=1&auditType=userTextInfo" funname="auditAllToPass"></t:dgToolBar>
 ...
 function audit(ids,flag) {
		var url="userInfoController.do?audit&auditType=userTextInfo&ids="+ids;
