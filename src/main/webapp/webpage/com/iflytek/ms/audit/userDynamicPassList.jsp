...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="userDynamicList" title="用户动态通过信息" actionUrl="userDynamicController.do?datagrid&auditstatus=1" idField="id"  checkbox="true" fit="true" queryMode="group">
   ...
   <t:dgCol title="状态" field="auditstatus" width="10" replace="待审核_0,审核通过_1,审核不通过_2"></t:dgCol>
  <t:dgCol title="帐号状态" field="userstatus" width="10" replace="已封号_0,正常_1" query="true"></t:dgCol>
