...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:1px;">
       ...
       <t:dgCol title="任务名称" field="name" query="true" width="12"></t:dgCol>
       <t:dgCol title="任务分组" field="group" query="true" width="12"></t:dgCol>
       <t:dgCol title="任务状态" field="status" query="true" dictionary="jobstatus" width="10" ></t:dgCol>
       <t:dgCol title="运行状态" field="runStatus" query="true" dictionary="runstatus" width="10" ></t:dgCol>
       <t:dgCol title="运行规则" field="expression" width="15"></t:dgCol>
       <t:dgCol title="是否异步" field="isSync" dictionary="jobissync" width="10"></t:dgCol>
       <t:dgCol title="任务描述" field="description" width="18"></t:dgCol>
       <t:dgCol title="操作" field="opt" width="30"></t:dgCol>
       <t:dgDelOpt title="立即运行" url="jobController.do?runOnce&id={id}" />
       <t:dgDelOpt title="暂停" url="jobController.do?pause&id={id}" />
       <t:dgDelOpt title="停止" url="jobController.do?del&id={id}" />
