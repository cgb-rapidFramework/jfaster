...
<t:formvalid formid="formobj" layout="div" dialog="true">
	...
	<div class="form"><label class="form"> <t:mutiLang langKey="operate.ip"/>: </label> ${logView.note}</div>
	...
	<div class="form"><label class="form"> <t:mutiLang langKey="common.browser"/>: </label> ${logView.broswer}</div>
